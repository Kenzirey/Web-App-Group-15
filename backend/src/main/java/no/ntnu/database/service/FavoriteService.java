...
import no.ntnu.database.repository.FavoriteRepository;
...
public class FavoriteService {
	...
	/**
	 * Returns all favorite entries for the specified {@link no.ntnu.database.model.User User}.
	 *
	 ...
	 * {@link no.ntnu.database.model.Course Course} and
	 * {@link no.ntnu.database.model.User User} ID.
	 *
