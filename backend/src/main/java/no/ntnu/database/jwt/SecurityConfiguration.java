...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain configureAuthorizationFilterChain(
        ...
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/courses/{id}").hasAuthority("ROLE_ADMIN")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:3000", "http://localhost:8080", "https://group15.web-tek.ninja, "));
